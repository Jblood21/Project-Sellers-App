import { HIGHLIGHT_CATEGORIES, mapsUrl } from '@shared/domain.js';
                  ...
                  <div style={{ padding: 14, display: 'flex', flexDirection: 'column', gap: 5 }}>
                    ...
                    {directions ? (
                      <a
                        ...
                        aria-label={`Open ${highlight.name} in Google Maps`}
                        style={{
                          display: 'flex', alignItems: 'center', gap: 7, marginTop: 4,
                          minHeight: 40, fontSize: 13, fontWeight: 700, lineHeight: 1.35,
                          color: 'var(--t-accT)', textDecoration: 'none',
                        }}
                      >
                        <Pin size={15} />
